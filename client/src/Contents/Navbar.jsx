            ...
            <div className="col-md-10 col-12 mx-auto">
                <nav className="navbar navbar-expand-lg">
                    <div className="container-fluid">
                      <a className="navbar-brand " href="/"> <i className="fa-sharp fa-solid fa-snowflake fa-spin fa-spin-reverse"></i> Weatherite <i className="fa-sharp fa-solid fa-snowflake fa-spin fa-spin-reverse"></i></a>
